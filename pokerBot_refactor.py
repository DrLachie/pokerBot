...
class Hand:
    ...
    def dealHand(self,deck):
        ...
        self.evaluateHand()  
        self.cards_readable = ['%s of %s' % (card[0], card[1]) for card in self.cards]
        return self
...
def findWinner(hand1,hand2):
    ...
    if hand1.ranking < hand1.ranking:
        print 'Hand 2 is the winner'
        
    if hand1.ranking == hand2.ranking:
        print evaluateDraw(hand1,hand2)
...
def evaluateDraw(hand1,hand2):
    ...
    if hand1.handName in  ['One Pair','Three of a Kind']:
        ...
        if hand1has == hand2has:
            print "I've decided this is a draw, both players have %ss" % hand1has
